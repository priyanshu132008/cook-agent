    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#FF4500]/25 bg-black/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl flex-col gap-3 px-5 py-3 md:flex-row md:items-end md:justify-between md:px-10 md:py-4">
        ...
        <nav className="flex flex-wrap items-center gap-1.5 text-[10px] font-black uppercase tracking-widest sm:gap-2 md:gap-3 md:text-xs">
          ...
          <a
            href="https://discord.gg/NKBaq526J"
            target="_blank"
            rel="noreferrer"
  ...
  return (
    <footer className="relative z-10 mt-24 w-full border-t border-gray-900 bg-black/80 px-5 py-10 md:px-10">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-5 text-center">
        <p className="max-w-2xl text-[10px] uppercase leading-relaxed tracking-widest text-neutral-400">
          THE WAR ROOM IS OPEN. JOIN THE ELITE COMMUNITY OF BUILDERS SHAPING THE FUTURE OF FERAL AI.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] text-[#FF4500]">
          ...
          <span className="text-gray-800">/</span>
          <a href="https://discord.gg/NKBaq526J" target="_blank" rel="noreferrer" className="border border-transparent px-2 py-1 transition-all hover:border-[#FF4500]/60 hover:text-white">
            Discord
          </a>
        </div>
        ...
        <div className="text-xs leading-relaxed text-gray-400">
          ...
          . Join the War Room on{' '}
          <a href="https://discord.gg/NKBaq526J" target="_blank" rel="noreferrer" className="font-black text-[#FF4500] underline-offset-4 transition-all hover:underline">
            Discord
          </a>
          , reach out on{' '}
